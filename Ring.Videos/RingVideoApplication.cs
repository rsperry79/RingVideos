...
namespace Ring.Videos
{
    public class RingVideoApplication
    {
        ...
        internal async Task<(bool, eNt.DoorbotHistoryEvent ding)> SaveRecordingAsync(int index, eNt.DoorbotHistoryEvent ding, Filter filter)
        {
            ...
            try
            {
                ...
                eNt.DownloadRecording downloadInfo = null;
                do
                {
                    attempt++;
