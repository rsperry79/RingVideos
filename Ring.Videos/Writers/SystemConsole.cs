...
namespace Ring.Videos.Writers
{
    ...
    public class SystemConsole : IConsole
    {
        ...
        {
            if (OperatingSystem.IsWindows()) TryEnableVirtualTerminalProcessing();
        }
        ...
        {
            // Console.SetBufferSize is Windows-only; a no-op elsewhere matches this class's
            // other best-effort, Windows-specific console tweaks (see TryEnableVirtualTerminalProcessing).
