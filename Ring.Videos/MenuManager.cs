...
namespace Ring.Videos
{
    ...
    {
        private readonly ForensicsConfiguration _forensicsConfig;
        private readonly string _configPath;

        public MenuManager(ForensicsConfiguration config, string configPath)
        {
        ...
        public async Task ShowMainMenuAsync()
        {
            ...
            AnsiConsole.MarkupLine("[bold green]    Ring.Videos - Evidence Management[/]");
            AnsiConsole.MarkupLine("[bold green]  DV Victim Protection & Forensics[/]");
            AnsiConsole.MarkupLine("[bold green]═══════════════════════════════════════[/]");
            ...
            while (true)
            {
                ...
                switch (choice)
                {
                    ...
                    case "Video Downloads":
                        AnsiConsole.MarkupLine("[cyan]Launching video download interface...[/]");
                    ...
                    case "Configuration":
                        ...
                        break;
                    case "Exit":
                        AnsiConsole.MarkupLine("[yellow]Exiting Ring.Videos...[/]");
                        return;
                }
